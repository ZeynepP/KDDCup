...
allowable_features = {
    ...
    'possible_numH_list_neighbours' : [0, 1, 2, 3, 4, 5, 6, 7, 8, 'misc'],
    ...
    'possible_total_valence' : [0, 1, 2, 3, 4, 5, 6, 7, 8, 'misc'],
    'possible_donnor' : [0, 1, 'misc'],
    'possible_acceptor' : [0, 1, 'misc'],
}
...
def atom_to_feature_vector(atom):
    ...
    atom_feature = [
        ...
        #    safe_index(allowable_features['possible_numH_list_neighbours'], atom.GetTotalNumHs(includeNeighbors=True)),
            safe_index(allowable_features['possible_number_radical_e_list'], atom.GetNumRadicalElectrons()),
            safe_index(allowable_features['possible_hybridization_list'], str(atom.GetHybridization())),
            allowable_features['possible_is_aromatic_list'].index(atom.GetIsAromatic()),
            allowable_features['possible_is_in_ring_list'].index(atom.IsInRing()),
        # From now on new features added
        #     safe_index(allowable_features['possible_total_valence'], str(atom.GetTotalValence())),
        #     safe_index(allowable_features['possible_donnor'], 0),
        #     safe_index(allowable_features['possible_acceptor'], 0),
...
def get_atom_feature_dims():
   ...
   #     allowable_features['possible_numH_list_neighbours'],
        allowable_features['possible_number_radical_e_list'],
        allowable_features['possible_hybridization_list'],
        allowable_features['possible_is_aromatic_list'],
        allowable_features['possible_is_in_ring_list'],
        # ZP adding new features
        # allowable_features['possible_total_valence'],
        # allowable_features['possible_donnor'],
        # allowable_features['possible_acceptor']
...
def atom_feature_vector_to_dict(atom_feature):
   ...
   # num_h_idx_n,
    ...
    feature_dict = {
       ...
       # 'num_h_n': allowable_features['possible_numH_list_neighbour'][num_h_idx_n],
        ...
        #ZP
        # 'total_valence' : allowable_features['possible_total_valence'][total_valence],
        # 'donnor': allowable_features['possible_donnor'][donnor],
        # 'acceptor': allowable_features['possible_acceptor'][acceptor]
    }
