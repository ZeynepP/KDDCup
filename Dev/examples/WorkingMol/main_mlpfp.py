...
### importing OGB-LSC
from ogb.lsc import PCQM4MDataset, PCQM4MEvaluator, PygPCQM4MDataset
...
class MLP(torch.nn.Module):
    def __init__(self, num_mlp_layers=5, emb_dim=300, drop_ratio=0, multi_model=False):
     ...
     #   self.emb_dim = emb_dim
        # mlp
        module_list = [
            torch.nn.Linear(35, self.emb_dim),
...
def main_mlp():
    ...
    dataset = PCQM4MDataset(root=args.data_dir, only_smiles=True)
