...
def main(args):
    ...
    checkpoint_name = 'checkpoint_normal.pt'
    ...
    model = KDD_Normal(**shared_params).to(device)
  ...
  #  scheduler = StepLR(optimizer, step_size=100, gamma=0.5)
    ...
    if args.log_dir is not '':
        writer = SummaryWriter(log_dir=args.log_dir, comment="normal")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if valid_mae < best_valid_mae:
            ...
            if args.checkpoint_dir is not '':
                ...
                torch.save(checkpoint, os.path.join(args.checkpoint_dir, checkpoint_name))
