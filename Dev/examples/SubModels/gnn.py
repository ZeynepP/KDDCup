...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_tasks = 1, num_layers = 3, emb_dim = 300,
                    gnn_type = 'gin', virtual_node = True, residual = False, drop_ratio = 0, JK = "last", graph_pooling = "sum", multi_model = False):
        '''
